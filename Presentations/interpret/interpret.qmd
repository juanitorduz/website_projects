...
![](interpret_files/static/images/model_to_meaning.png){fig-align="center" width="1000"}
...
::: {.bordered}
![](interpret_files/static/images/ads_roas_interpret_34_0.png){fig-align="center" width="700"}
:::
...
::: {.bordered}
![](interpret_files/static/images/ads_roas_interpret_94_0.png){fig-align="center" width="750"}
:::
...
formula = bmb.Formula(
    "budget_next ~ 1 + cohort_age + C(month_of_year) + hsgp(roas, m=20, c=1.5, cov='Matern52')"
)
```
...
::: {.bordered}
![](interpret_files/static/images/ads_roas_interpret_131_0.png){fig-align="center" width="750"}
:::
...
::: {.bordered}
![](interpret_files/static/images/ads_roas_interpret_134_0.png){fig-align="center" width="550"}
:::
...
::: {.bordered}
![](interpret_files/static/images/ads_roas_interpret_137_0.png){fig-align="center" width="550"}
:::
...
## Slopes: Marginal Effect of ROAS {.smaller}

Derivative of the ROAS effect with respect to ROAS.

::: {.bordered}
![](interpret_files/static/images/ads_roas_interpret_158_0.png){fig-align="center" width="750"}
:::

::: {.callout-tip appearance="simple"}
- From a ROAS values close to zero, the ROAS effect is negative.
- ROAS values close to $1.5$ hve the largest sensitivity to ROAS changes (steeper slope).
...
::: {.bordered}
![](interpret_files/static/images/ads_roas_interpret_154_0.png){fig-align="center" width="700"}
:::
...
::: {.bordered}
![](interpret_files/static/images/ads_roas_interpret_157_0.png){fig-align="center" width="750"}
:::
...
- Notebook: [https://juanitorduz.github.io/ads_roas_interpret/](https://juanitorduz.github.io/ads_roas_interpret/)

- Slides: [https://juanitorduz.github.io/html/interpret.html](https://juanitorduz.github.io/html/interpret.html)
:::
