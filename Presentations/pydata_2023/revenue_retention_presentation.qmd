...
1. An individual remains a customer of the company with constant retention probability $1 - \theta$. This is equivalent to assuming that the duration of the customer’s relationship with the company, denoted by the
random variable $T$, is characterized by the (shifted) geometric distribution with probability mass
...
2. Heterogeneity in $\theta$ follows a beta distribution $\theta \sim \text{Beta}(a, b)$.
