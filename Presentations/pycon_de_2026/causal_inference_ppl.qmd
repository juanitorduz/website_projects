...
Simple Bayesian A/B test model to estimate the relative lift between a control and a treatment groups in a balanced experiment.
...
Even if we set informative priors for the conversion rates, the relative lift range is still unreasonable wide.
