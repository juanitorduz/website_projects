...
conditioned_model = observe(
    earnings_model,
    {"treat": training_obs,
     "earnings": earnings_obs},
)

# Counterfactual interventions
do_0_model = do(
    conditioned_model,
    {"treat": np.zeros(n_obs)}
)
do_1_model = do(
    conditioned_model,
    {"treat": np.ones(n_obs)}
...
<!-- TODO: export counterfactual HDI plot from intro_causal_inference_ppl_pymc.ipynb -->
![](causal_inference_ppl_files/static/images/intro_causal_inference_ppl_pymc/counterfactual_hdi.png){fig-align="center" width="900"}
