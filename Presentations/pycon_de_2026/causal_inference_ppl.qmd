...
This **does not not** imply that Bayesian methods are better than frequentist methods! For every framework, you need to know the assumptions and the limitations.
:::
...
*Taken from Robert O. Ness's book: [Causal AI](https://www.robertosazuwaness.com/causal-ai-book/).*
