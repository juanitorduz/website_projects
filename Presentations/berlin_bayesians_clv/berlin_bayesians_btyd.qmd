...
$$
CLV = \sum_{i=1}^{\infty} \frac{M_i}{(1+\delta)^t}
$$
...
![](berlin_bayesians_btyd_files/images/model_summary.png){fig-align="center"}

::: footer
See [“Counting Your Customers” the Easy Way: An Alternative to the Pareto/NBD Model](http://brucehardie.com/papers/018/fader_et_al_mksc_05.pdf) and[Probability Models for Customer-Base Analysis](https://www.brucehardie.com/talks/ho_cba_tut_art_09.pdfl)
:::
...
![](berlin_bayesians_btyd_files/images/trace_m2.png){fig-align="center"}
...
![](berlin_bayesians_btyd_files/images/alpha_posterior.png){fig-align="center"}
...
- [Probability Models for Customer-Base Analysis](https://www.brucehardie.com/talks/ho_cba_tut_art_09.pdfl)
