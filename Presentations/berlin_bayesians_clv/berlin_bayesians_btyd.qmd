...
flowchart LR
  ...
  A[Transaction Data] --> C(Monetary Model - GG)
  B(Transaction Model - BG/NBD) --> D[Probability of Alive]
  B(Transaction Model - BG/NBD) --> E[Predicted Frequency]
  C(Monetary Model - GG) --> F[Predicted Avg. Monetary Value]
  E[Predicted Frequency] --> G[Predicted CLV]
  F[Predicted Avg. Monetary Value] --> G[Predicted CLV]
```
