...
## Hilbert Space Approximation Deep Dive {.center}
...
We use a [`ZeroSumNormal`](https://www.pymc.io/projects/docs/en/stable/api/distributions/generated/pymc.ZeroSumNormal.html) distribution to capture the relative difference across weekdays. We couple it with a multiplicative factor parametrized by a Gaussian process.

## HSGP Model - Special Days

![](hsgp_intro_files/static/images/birthdays_files/birthdays_76_1.png){fig-align="center" width="950"}

We use a [`StudentT`](https://www.pymc.io/projects/docs/en/stable/api/distributions/generated/pymc.StudentT.html) distribution over the `day_of_year2`.
