...
This talk is based on \href{https://juanitorduz.github.io/interpretable_ml/}{this} block post (\cite{interpretable_ml_orduz_2021}), which itself is based on these two amazing references:
\begin{itemize}
