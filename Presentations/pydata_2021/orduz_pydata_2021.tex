...
\begin{frame}{Interpretable ML $\neq$ Causality}{See \cite{molnar2020interpretable} for a Brief History of Interpretable ML and comments on Causality}
...
\item \href{https://xcelab.net/rm/statistical-rethinking/}{Statistical Rethinking, A Bayesian Course with Examples in R and Stan by Richard McElreath} (\cite{statrethinkingbook})
\item \href{https://mixtape.scunning.com/index.html}{Causal Inference: The Mixtape by Scott Cunningham} (\cite{10.2307/j.ctv1c29t27})
\end{itemize}
\pause
\end{block}
{\bf Remark:} The article \href{https://arxiv.org/abs/2007.04131}{General Pitfalls of Model-Agnostic Interpretation Methods for Machine Learning Models} (\cite{molnar2021general}) is highly recommended to understand the challenges, limitations and recommendations for some of the model-agnostic methods discussed in this talk.
\end{frame}
...
\begin{center}
  \begin{figure}
    ...
    \caption{Lasso model with second order polynomial interactions (\cite{scikit-learn}).}
  \end{figure}
\end{center}
\begin{center}
  \begin{figure}
    \includegraphics[scale=0.3]{images/tree_grid_search.png}
    \caption{XGBoost regression model (\cite{Chen:2016:XST:2939672.2939785}).}
  \end{figure}
\end{center}
\end{frame}
...
\begin{frame}{$\beta$ coeffiecients}{See \cite[Section 5.1]{molnar2019}}
\begin{align*}
...
\begin{frame}{SAHP Values}{Definition, see \cite{NIPS2017_7062}, and \cite[Chapters 5 \& 6]{masis2021} and \cite[Section 9.6]{molnar2019}}
...
\begin{center}
  \begin{figure}
    ...
    \caption{This figure shows the SHAP values a a function of temperature. Compare with Figure \ref{fig:pdp-ice}}
  \end{figure}
\end{center}
\end{frame}
