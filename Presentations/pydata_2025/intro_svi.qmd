...
{{< video https://www.youtube.com/watch?v=XECLmgnS6Ng width="80%" height="600" >}}
:::
...
- Stochastic Variational Inference (SVI) is a calable **approximate inference method that transforms the problem of posterior inference into an optimization problem**.
...
![](intro_svi_files/static/images/juanitorduz.png){.absolute top=0 right=0 width=600 height=600}