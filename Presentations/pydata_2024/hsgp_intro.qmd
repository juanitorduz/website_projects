...
::: {.callout-note title="Eigenvalue Problem"}
...
That is,
  ...
  $$
  \int_{\Omega} {\color{blue}{(-\nabla^2 f(x))}} g(x) dx = \int_{\Omega} f(x) {\color{blue}{(-\nabla^2 g(x))}} dx
  $$
