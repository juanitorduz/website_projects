...
![](pymc_lr_files/pymc_lr_3_0.svg){fig-align="center"}
...
:::
::: {.column width="50%"}
![](pymc_lr_files/pymc_lr_5_0.svg){fig-align="center"}
:::
:::
...
![](pymc_lr_files/pymc_lr_8_0.svg){fig-align="center"}
...
![](pymc_lr_files/pymc_lr_14_0.svg){fig-align="center"}

## Posterior Predictive (Training Set)

::: columns
::: {.column width="50%"}
![Posterior distribution of $\mu$.](pymc_lr_files/pymc_lr_16_0.svg)
:::
::: {.column width="50%"}
![Posterior distribution of $y$.](pymc_lr_files/pymc_lr_17_0.svg)
:::
:::
...
::: columns
::: {.column width="50%"}
![Posterior distribution of $\mu$.](pymc_lr_files/pymc_lr_21_0.svg)
:::
::: {.column width="50%"}
![Posterior distribution of $y$](pymc_lr_files/pymc_lr_22_0.svg)
:::
:::
