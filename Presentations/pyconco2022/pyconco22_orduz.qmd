...
![Posterior samples distriibution viia NUTS sampler in PyMC. For each parameter we run 4 iindependent chains with 1000 samples each.](pymc_lr_files/pymc_lr_15_0.svg){fig-align="center"}
...
<center>
<img src="bikes_pymc_files/bikes_pymc_48_0.svg"  width="1000">
</center>

## Example: Bike Rental Model
### Time-Varying Coefficients

![hola](bikes_pymc_files/bikes_pymc_50_0.svg)
