...
- **Supply Chain Forecasting**
  - Demand forecasting with stockout constraints
  - Account for availability and regulatory constraints
  - Spare parts inventory optimization
  - Long-tail product forecasting

- **Electricity Demand Forecasting**
  - Weather-dependent demand modeling
  - Peak load prediction with uncertainty
...
- **Price Elasticity Modeling**
  - Hierarchical models for SKU-level pricing
  - Promotional effectiveness measurement

- **Marketing Mix Models with Lift Test Calibration**
  - Measure media effectiveness
  - Calibrate incrementality with experimental data
...
::: footer
[Probabilistic Time Series Analysis: Opportunities and Applications](https://www.pymc-labs.com/blog-posts/probabilistic-forecasting)
:::

## Statsmodels - Time Series Models 🤓

![](probabilistic_forecasting_files/static/images/statsmodels_docs.png){fig-align="center" width="800"}
...
![](probabilistic_forecasting_files/static/images/nitxla_gh.png){fig-align="center" width="1000"}
...
## $\text{VAR}(p)$ Models and IRF

![](probabilistic_forecasting_files/static/images/var_irf.png){fig-align="center" width="650"}

::: footer
[Bayesian Vector Autoregressive Models in NumPyro](https://juanitorduz.github.io/var_numpyro/)
:::
...
- [Introduction to Stochastic Variational Inference with NumPyro](https://juanitorduz.github.io/intro_svi/) ⭐
- [Bayesian Censoring Data Modeling](https://juanitorduz.github.io/censoring/)
- [Bayesian Vector Autoregressive Models in NumPyro](https://juanitorduz.github.io/var_numpyro/)
- [Croston's Method for Intermittent Time Series Forecasting in NumPyro](https://juanitorduz.github.io/croston_numpyro/)
- [Demand Forecasting with Censored Likelihood](https://juanitorduz.github.io/demand/)
