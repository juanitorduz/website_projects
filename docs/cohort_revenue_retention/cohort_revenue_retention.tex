...
this framework is flexible enough to incorporate additional parametrizations for the revenue component. {\em The true key ingredient is
        having a Bayesian model with two likelihoods (retention and revenue) that are coupled through the number of active users.} \\
