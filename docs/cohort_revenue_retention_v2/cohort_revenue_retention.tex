...
\section{A Real-Dataset Application: The H\&M Transactions Dataset}
...
forecasting in business contexts (using tow established data science libraries: the Nixtla forecasting framework \cite{nixtla} and the
...
By combining the flexibility of Bayesian additive regression trees (or neural networks) with the interpretability of linear models, our approach
