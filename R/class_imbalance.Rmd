...
This notebook should serve as an extension of my talk given at [satRday Berlin 2019: A conference for R users in Berlin](https://berlin2019.satrdays.org/). Here are the slides:

```{r, echo=FALSE}
knitr::include_url(url = "/html/orduz_satRday19.html") 
```
