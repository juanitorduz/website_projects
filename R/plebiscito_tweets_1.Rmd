...
**Remark:** The reference [A User’s Guide to Network Analysis in R](https://www.amazon.de/Users-Guide-Network-Analysis/dp/3319238825/ref=sr_1_1?ie=UTF8&qid=1545301676&sr=8-1&keywords=network+analysis+R) is highly recomended if you want to go deeper into network analysis in R. 
...
We see that 12 groups where identified and the modularity is 0.7 (which is good, as it is close to 1). Now we encode the membership as a node atribute (zoom and click on each node to explore the clusters). 
